...
;**            
;**             ���ڣ�   2004.11.8
;**             ������  lpc2200.h�ļ���Ӳ�������Դ�����ļ���֧��LPC2200ϵ��оƬ��Lpc2100ϵ��
;**                     оƬ������ÿ��C��C++���򹤳̱���������ļ�����ɶ�ARM��Դ�ķ��䣬����
;**                     VPB�����ַ�ɸ��ļ����䣬����ĵ�ַӦ������ʵ��Ӳ����Դ��ͬ������ķ�
;**                     �佫���³�������в�������
;**
;**------------------------------------------------------------------------------------------------------
;********************************************************************************************************/
...
/*假如 0xE0028004 是一扇门的地址：
 *volatile 确保我们每次都亲自去看这扇门的状态，而不是记住上次看的状态。
 *指针引用让我们给这扇门取个名字，比如 IO0SET，方便以后调用它，而不是每次记住复杂的地址编号。*/
